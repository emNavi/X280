...
void odom_callback(const nav_msgs::Odometry::ConstPtr& msg)
{
  ...
  poseROS.header.frame_id = string("uav_world");
  ...
  velROS.header.frame_id = string("uav_world");
  ...
  if (cov_pos)
  {
    ...
    covROS.header.frame_id = string("uav_world");
  ...
  if (cov_vel)
  {
    ...
    covVelROS.header.frame_id = string("uav_world");
  ...
  if ((t - pt).toSec() > 0.5)
  {
    trajROS.header.frame_id = string("uav_world");
  ...
  // Sensor availability
  sensorROS.header.frame_id = string("uav_world");
  ...
  if (tf45)
  {
    ...
    broadcaster->sendTransform(tf::StampedTransform(transform,   msg->header.stamp, string("uav_world"), base_s));      
...
int main(int argc, char** argv)
{
  ...
  n.param("frame_id",   _frame_id, string("uav_world") ); 
